  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(GoogleMapsSearchBar, [{
    ...
    value: function componentDidMount() {
      if (this.props.addressData) {
        var _addressData = this.props.addressData;
        this.setState({
          queryString: "".concat(_addressData[0].long_name, " ").concat(_addressData[1].long_name, ", ").concat(_addressData[2].long_name, ", ").concat(_addressData[4].long_name)
        });
      }
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.addressData !== prevProps.addressData) {
        var _addressData2 = this.props.addressData;
        this.setState({
          address: _addressData2,
          queryString: "".concat(_addressData2[0].long_name, " ").concat(_addressData2[1].long_name, ", ").concat(_addressData2[2].long_name, ", ").concat(_addressData2[4].long_name)
        });
      }
    }
...
//# sourceMappingURL=add-review.js.e64bdb0a616067e0934b.hot-update.js.map