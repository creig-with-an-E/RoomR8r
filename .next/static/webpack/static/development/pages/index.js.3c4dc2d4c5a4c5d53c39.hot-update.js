...
var findReviewByAddress = function findReviewByAddress(userToken, address) {
  ...
  return function (dispatch) {
    dispatch(findByAddressStart()); // axios.get(`https://accomo-rater.firebaseio.com/landlord_data.json?auth=${
    //   userToken}&orderBy="postal_code"&startAt="${address}"&endAt="${
    //   address }"`
    // )

    var searchParametersPassed = "&orderBy=\"postal_code\"&startAt=\"".concat(address, "\"&endAt=\"").concat(address, "\"");
...
//# sourceMappingURL=index.js.3c4dc2d4c5a4c5d53c39.hot-update.js.map