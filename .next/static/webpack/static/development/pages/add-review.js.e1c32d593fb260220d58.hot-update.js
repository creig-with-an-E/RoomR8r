  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(GoogleMapsSearchBar, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.addressData !== prevProps.addressData) {
        ...
        this.setState({
          address: addressData,
          queryString: "".concat(addressData[0].long_name, " ").concat(addressData[1].long_name, ", ").concat(addressData[3].long_name, ", ").concat(addressData[4].long_name)
        });
      }
    }
...
//# sourceMappingURL=add-review.js.e1c32d593fb260220d58.hot-update.js.map